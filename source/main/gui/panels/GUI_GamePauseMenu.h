...
class GamePauseMenu // TODO: Copypaste of 'GameMainMenu' -- cleanup and unify the logic!
{
public:
    // This class implements hand-made keyboard focus - button count must be known for wrapping
    const size_t  NUM_BUTTONS           = 4; // Buttons: Resumegame, ChangeMap, BackToMenu, Quitgame
