...
bool                 GetDiagLogConsoleEcho      ();
bool                 GetDiagLogBeamBreak        ();
bool                 GetDiagLogBeamDeform       ();
bool                 GetDiagLogBeamTrigger      ();
bool                 GetDiagDofEffect           ();
...
void SetDiagLogConsoleEcho   (bool                v);
void SetDiagLogBeamBreak     (bool                v);
void SetDiagLogBeamDeform    (bool                v);
void SetDiagLogBeamTrigger   (bool                v);
void SetDiagDofEffect        (bool                v);
